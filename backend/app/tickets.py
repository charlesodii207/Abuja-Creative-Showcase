...
def issue_ticket_and_email(db: Session, registrant: models.Registrant) -> models.Ticket:
    ...
    confirmed, and emails them the ticket number + QR code. Safe to call
    more than once for the same registrant — if a ticket already exists,
    it's reused rather than duplicated or re-emailed.
    """
    ...
    send_email(
        ...
        <p>Show the QR code below at the entrance. If it can't be scanned, staff can type in your ticket number instead.</p>
        <img src="data:image/png;base64,{qr_base64}" alt="Ticket QR Code" style="width:220px;height:220px;" />
