...
export const socials = [
  {
    name: "TikTok",
    url: "https://www.tiktok.com/@afrigosfilmacademy",
...
export const about = {
  ...
  body: [
    ...
    "Afriqa Creative Showcase brings the two together over two days: creative markets, screenings, live performances, industry conversations, masterclasses, a finance forum, and a pitching room, all in one space.",
  ],
};
    ...
    sessions: [
      {
        ...
        detail:
          "Welcome, keynote, state of Abuja's creative economy, official opening of the Creative Market.",
      },
      {
        time: "Midday",
        label: "Creative Industry Conversations",
        detail:
          "Parallel sessions across film & TV, music, fashion, art & photography, publishing, digital media, and creative technology.",
      },
      {
        time: "Afternoon",
        label: "Creative Finance Forum",
        detail:
          "Funding opportunities, investor conversations, government programmes and grants.",
      },
      {
        time: "Evening",
        label: "Film & Creative Showcase",
        detail:
          "Curated screenings, artist conversations, performances.",
      },
    ],
  },
  {
    ...
    sessions: [
      {
        time: "Morning",
        label: "Masterclasses & Workshops",
        detail:
          "Practical sessions for emerging and established creatives.",
      },
      {
        time: "Midday",
        label: "Pitching & Deal Room",
        detail:
          "Selected projects pitch to investors, commissioners, brands, distributors and funders.",
      },
      {
        time: "Afternoon",
        label: "International Opportunities Hub",
        detail:
          "International programmes, markets, fellowships, grants and collaborations.",
      },
      {
        time: "Afternoon/Evening",
        label: "Fashion, Art & Creative Showcase",
        detail:
          "Fashion presentations, visual art and photography exhibitions running alongside the day's programme.",
      },
      {
        time: "Evening",
        label: "ACS Live Concert & Closing Celebration",
        detail:
          "A major live entertainment experience closing out the Showcase.",
      },
    ],
  },
];
...
export const faqs = [
  {
    q: "Who is Afriqa Creative Showcase for?",
...
export const participationCategories = [
  ...
  },
  {
    ...
    slug: "investor",
    blurb:
      "Meet curated pitching participants and discover investable creative projects in the Deal Room.",
    note: "",
    guaranteed: false,
  },
];