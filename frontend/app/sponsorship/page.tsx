...
export const metadata: Metadata = {
  ...
  description:
    "Partner with Afriqa Creative Showcase 2026. Six sponsorship tiers, from Bronze to Title Partner, connecting your brand with Abuja's creative industry.",
  alternates: {
...
function GemIcon({ color }: { color: string }) {
  return (
    <svg viewBox="0 0 48 48" className="h-10 w-10">
      <path
        d="M12 16 L24 8 L36 16 L24 42 Z"
        fill={color}
        opacity="0.9"
      />
      <path
        d="M12 16 L24 8 L18 16 Z"
        fill="white"
        opacity="0.25"
      />
      <path
        d="M12 16 L24 42 L18 16 Z"
        fill="black"
        opacity="0.15"
      />
      <path
        d="M36 16 L24 42 L30 16 Z"
        fill="black"
        opacity="0.25"
      />
    </svg>
...
function CrownIcon({ color }: { color: string }) {
  return (
    <svg viewBox="0 0 48 48" className="h-10 w-10">
      <path
        d="M6 36 L10 16 L18 26 L24 12 L30 26 L38 16 L42 36 Z"
        fill={color}
      />
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-20 md:py-28">
      ...
      <p className="mt-3 max-w-xl text-muted">
        Six tiers, from Bronze to Title Partner. Reach out and we&apos;ll walk
        you through what fits best.
      </p>
      ...
      <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {sponsorshipTiers
          ...
          .map((tier) => {
            ...
            const usdEquivalent = Math.round(
              tier.amount / NAIRA_PER_USD / 100
            ) * 100;
      ...
      <div className="mt-10 rounded-2xl border border-teal/20 bg-ink-raised px-8 py-10 text-center">
        <p className="text-muted">
          Ready to partner with Afriqa Creative Showcase?{" "}
          <a
            href="mailto:partnerships@africacreativeshowcase.com"
