...
export const metadata: Metadata = {
  ...
  description:
    "Abuja Creative Showcase 2026 brings filmmakers together for screenings, industry networking, and direct access to distributors and funders — through the Screening Room and Creative Finance track.",
  keywords: [
    "film events Abuja",
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-20 md:py-28">
      ...
      <h1 className="font-display text-3xl text-cream sm:text-4xl">
        Film at Abuja Creative Showcase
      </h1>
      <p className="mt-4 max-w-2xl text-lg leading-relaxed text-muted">
        ACS isn&apos;t a film festival — it&apos;s where film sits alongside music, fashion,
        and tech as part of a wider creative industry event. For filmmakers, that means
        screenings and networking without competing only against other films for attention,
        plus direct access to the finance and investment track happening in the same space.
      </p>
      ...
      <div className="mt-16 rounded-2xl border border-teal/20 bg-ink-raised px-8 py-10 text-center">
        ...
        <p className="mt-3 text-muted">
          Register to attend, or explore the finance track if you&apos;re seeking funding.
        </p>
