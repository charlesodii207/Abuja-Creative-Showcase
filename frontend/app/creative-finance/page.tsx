...
export const metadata: Metadata = {
  ...
  description:
    "Afriqa Creative Showcase 2026's Creative Finance Forum connects filmmakers, musicians, fashion brands, and creative entrepreneurs with investors, funders, and distributors through a dedicated Pitch & Deal Room.",
  keywords: [
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-20 md:py-28">
      ...
      <p className="mt-4 max-w-2xl text-lg leading-relaxed text-muted">
        Afriqa Creative Showcase 2026 isn&apos;t only a showcase of creative
        work — it&apos;s where that work meets capital. A dedicated finance
        and investment track runs alongside the main event, built for
        creatives who need funding and investors looking for Nigeria&apos;s
        next opportunity.
      </p>
